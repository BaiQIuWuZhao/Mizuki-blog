...
export const siteConfig: SiteConfig = {
	title: "Blog of BaiQiuWuZhao",
	subtitle: "一个神秘的小屋",
	siteURL: "https://baiqiuwuzhao.com/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "1097631", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: true, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "1663138114", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		imageApi: {
			...
			url: "https://api.yppp.net/api.php", // API地址，返回每行一个图片链接的文本
		},
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/BaiQIuWuZhao",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1663138114",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "QQ",
					url: "tencent://AddContact/?fromId=45&fromSubId=1&subcmd=all&uin=3276192042&website=www.oicqzone.com",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/音理.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "白秋五兆",
	bio: "这个世界就是个巨大的宝石箱，里面塞满了熠熠生辉的宝石",
	typewriter: {
	...
	links: [
		...
		},
		{
			...
			url: "https://discord.gg/4vhXtQ6Jv9",
		},
	],
};
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo.baiqiuwuzhao.com/",
		lang: SITE_LANG,
	},
};
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "*这里充满了白的味道，你对此感到充满了决心。", // 公告内容
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		home: "点击这里返回首页！", // 首页提示
		skin: ["想看我穿别的衣服？", "这衣服穿着挺舒服。"], // 换装提示
		close: "QWQ 下次再见！", // 关闭提示
		link: "https://github.com/BaiQiuWuZhao", // 关于链接
	},
};
